          ...
          <div className="w-full  text-white py-8 px-4 ">
            <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-10">
              ...
              <div className="w-full lg:w-1/2 space-y-6">
                ...
                <p className="text-zinc-300 text-dm sm:text-md">{currentCampaign?.args?.description}</p>
                ...
                <div className="p-4 bg-[#1e1f24] rounded-2xl">
                  ...
                  <p className="hidden sm:block text-[#facc15] break-words">
                    {currentCampaign?.args?.creator}
                  </p>

                  <p className="block sm:hidden text-[#facc15] break-words">
                    {`${currentCampaign?.args?.creator.slice(0, 9)}...${currentCampaign?.args?.creator.slice(-9)}`
                    }
                  </p>
                </div>
